...
| `realtime/` | EXTENSION — realtime bridge | `office:agents` roster fan-out bridge (BDP-2301). Monkeypatches `SqlAlchemyAgentStore` at lifespan startup; depends on `bytedesk_omnigent.realtime.publisher`. |
