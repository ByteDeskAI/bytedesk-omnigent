...
(:mod:`bytedesk_omnigent.policies.github`) — the single ``github_policy``
...
from bytedesk_omnigent.policies.github import github_policy
...
_HANDLER = "bytedesk_omnigent.policies.github.github_policy"
_REPO = "octo/hello"
